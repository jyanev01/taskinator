...
// crate array to hold tasks for saving
var tasks = [];
...
var loadTasks = function() {
  ...
  // if there are no tasks, set tasks to an empty array and return out fo the function
  if(!savedTasks) {
    return false;
  }
  console.log("Saved tasks found!");
  // else, lead up saved tasks
